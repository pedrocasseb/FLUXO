...
export const Navbar: React.FC<NavbarProps> = ({ onNavigate, currentPage = 'home' }) => {
  ...
  return (
    <div className="fixed top-6 left-0 w-full z-50 px-4 pointer-events-none">
      <nav className={`mx-auto max-w-[960px] w-full rounded-full transition-all duration-300 pointer-events-auto border ${
        scrolled 
        ...
        <div className="flex items-center justify-between">
          ...
          <a 
            ...
            className="flex items-center gap-2 text-xl font-semibold tracking-[-0.64px] text-[#0d253d] select-none"
          >
            <img src="/logo.png" alt="FLUXO" className="h-7 w-auto object-contain" />
